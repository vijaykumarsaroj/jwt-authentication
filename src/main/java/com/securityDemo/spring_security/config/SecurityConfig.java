package com.securityDemo.spring_security.config;

import com.securityDemo.spring_security.security.JwtAuthenticationEntryPoint;
import com.securityDemo.spring_security.security.JwtAuthenticationFilter;
...
//                .build();
//
//        return new InMemoryUserDetailsManager(vijay,admin);
//    }
